...
\author{Alexander Lindsay, Katy Huff, Andrei Rykhlevskii} % As you author additions/changes, add
                                      % your name here!!!
...
A cutaway diagram of the MSRE reactor is shown in \cref{fig:MSRE_reactor}. Fuel
enters through the inlet and is distributed evenlgy along the outside of the
...
bulk salt temperature (1175 \textdegree F). \cite{robertson_msre_1965} Some MSRE
...
0.4-inch by 1.2-inch fuel channels that are formed by machinging grooves in the
...
Though studies were conducted with the MSRE core surrounded by varying
...
the constant of proportionality determined from steady-state MSRE operational
...
the actual MSRE geometry was simplified as shown in \cref{fig:real-vs-model}
...
\begin{figure}[htpb]
  ...
  \caption{Left figure shows snapshot of actual MSRE core geometry; to satisfy
...
\subsection{ARFC MSRE Model Design Plan}

\begin{enumerate}
\item Test whether \code{gmsh} can generate heterogeneous 3D mesh structure
  like that in the actual MSRE geometry.
